...
// Create a function called 'oddChecker' that takes in one parameter, num. Check to see if the number is even or odd. If it is odd, return
//  'the number is odd' or return 'the number is even' if it is even.
...
// // Create a function called 'iLove' that takes in two parameters, name which will be a string  and love which will be a string of something you
//  love. Have the function take the two parameters and retrun a string that says "NAMEPARAM loves LOVEPARAM" with the appropriate parameters in 
//  the string. e.g. "Bryan loves skateboarding"
...
// state will be your current state or providence as a string. age will be your age as a number. greeter will be a method that returns the string
...
// // Create a function called 'bigOrSmall' that takes in one parameter, arr. Create a new array inside of bigOrSmall called 'answers'. Loop over the 
// passed in arr param. If the number is GREATER than 100, push 'big' as a string to the answers array. If the number is LESS than or EQUAL to 100, 
// push 'small' as a string to the answers array. Return the answers array inside of the function
...
// Using a for loop, loop over the passed in array in reverse and add each item to the new reversed array. Finally, return the new reversed array
...
// Code Here
let total = myNumbers.reduce(function(accum, num){
	return accum + num
})

//////////////////PROBLEM 17////////////////////

// Last, lets use .forEach to find the index of each item in the array. First, create an empty array called myNumbersIndex. Next, using forEach,
//  push each items index from the myNumbers array to the myNumbersIndex array

// Code Here
let myNumbersIndex = []
myNumbers.forEach(function(index){
	myNumbersIndex.push(myNumbersIndex.length)
})


//////////////////PROBLEM 18////////////////////

// Did you know that George Foreman has five sons named George? Let's go ahead and change everyone's name in the notGeorge array to 
// George using .map. Call the new array 'forTheLoveOfGeorge'
...
// Code Here
let totallyAwesome = people.reduce(function(accum, value){
	console.log(value)
	return accum + value.awesomeLevel
}, 0)
