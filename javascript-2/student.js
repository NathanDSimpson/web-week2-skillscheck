...
//////////////////STEP 1////////////////////
//Create a variable called lovesCode and set it true or false (as a boolean) depending on if you love code or 
// not. It's okay if you don't, yet
...
//////////////////STEP 5////////////////////
//Create an if statement that checkes to see if the lovesCode variable is equal to true, if it is, set the 
// phrase variable created above to 'I love code', it it's not true set the phrase variable to 'I do not love to code'
